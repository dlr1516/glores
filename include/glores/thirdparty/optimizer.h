#ifndef NELDER_MEAD_OPTIMIZER_H
#define NELDER_MEAD_OPTIMIZER_H
...
//                std::cout << __FILE__ << "," << __LINE__ << ": coords.size() " << coords.size() << " v.coords.size() " << v.coords.size() << std::endl;
//                std::cout << "  coords [";
//                for (int i = 0; i < coords.size(); ++i) {
//                    if (i == 0) std::cout << coords[i];
//                    else std::cout << ", " << coords[i];
//                }
//                std::cout << "]" << std::endl;
            }
